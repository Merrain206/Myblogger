...
核心策略基于人工势场 (APF) 算法实现智能避障，结合球轨迹预测和基于角色的定位系统 (守门员、前锋、中场、后卫)，让多个机器人能够协同作战。`,
  ...
  },
  {
    ...
    slug: "ai-gomoku",
    description:
      "15x15 五子棋对战，支持人机对弈和在线联机。AI 采用 Minimax + Alpha-Beta 剪枝，WebSocket 实时通信，Nginx 反向代理部署。",
    techStack: ["HTML/CSS", "JavaScript", "Canvas", "Minimax", "WebSocket", "Nginx"],
    demoUrl: "/gomoku",
    featured: true,
    features: [
      "人机对战 + 在线联机对战双模式",
      ...
      "WebSocket 实时通信，2 间固定房间，30s 自动解散",
